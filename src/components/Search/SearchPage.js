...
export default SearchPage = (props) => {
	...
	// Retrieve the recently searched items
		...
		axios.post(searchResultsEndpoint, postData, axiosConfig)
			.then((response) => {
				if (response["data"]["totalHits"] != 0) {
					...
					storeRecentlySearchedData(foodItem);
					retrieveRecentlySearchedData()
						.then((resp) => {
          ...
          <ScrollView style={styles.container}
            ...
            <View style={styles.MainContainer}>
              ...
              <FlatList
				...
				// FlatListItem Separator is implemented in this component yet
				// TODO: Implement FlatListItemSeparator
